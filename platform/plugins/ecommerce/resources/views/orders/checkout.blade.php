                                ...
                                <div class="position-relative">
                                    ...
                                    <ul class="list-group list_payment_method">
                                        <li class="list-group-item">
                                            <input class="magic-radio " type="radio" name="payment_method" id="savings" checked  value="savings">
                                            <label for="savings" class="text-start">CoopEast Savings</label>
                                            <img src="{{ asset('storage/coop_savings.png') }}" width="132" height="64" alt="image">
                                        </li>
                                        <li class="list-group-item">
                                            <input class="magic-radio " type="radio" name="payment_method" id="loan"  value="loan">
                                            <label for="loan" class="text-start">CoopEast Loan</label>
                                            <img src="{{ asset('storage/coop_loan.png') }}" width="132" height="64" alt="image">
                                        </li>
                                        <li class="list-group-item">
                                            <input class="magic-radio " type="radio" name="payment_method"  id="paystack" value="paystack">
                                            <label for="paystack" class="text-start">Paystack</label>
                                            <img src="{{ asset('storage/paystack.png') }}" width="132" height="64" alt="image">
                                        </li>
                                    </ul>
